...
LLM_SYSTEM_TEMPLATES = {
    "ru": (
        ...
        "- Русифицированные IT-глаголы исправлять: "
        "задеплойить→задеплоить, захвостить→захостить, замёржить→замержить, "
        "запуршить→запушить, закомитить→закоммитить, зарелизнуть→зарелизить, "
        "отдебагнуть→отдебажить, форкануть→форкнуть.\n"
